...
export const en: Messages = {
  ...
  auth: {
    ...
    headlineTail: "KITCHEN",
    subline: "",
    blurb:
      "Stock, recipes, profit — everything your kitchen needs, in one place.",
  ...
  pl: {
    title: "Profit & loss",
    description:
      "Day · week · this month · last month — revenue, cost of goods, overhead, and the unallocated pool.",
    today: "Today",
    week: "This week",
    month: "This month",
    ...
    sectionExpenses: "Overhead expenses",
    ...
    colIngredientCost: "Ingredient cost",
  ...
  ingredients: {
    ...
    categoryHint:
      "Full category name (e.g. რძის ნაწარმი). ID becomes რ-21 automatically.",
  ...
  resale: {
    ...
    empty: "Nothing here yet — add the first resale item",
    unitCost: "Unit cost",
    unitCostFull: "Unit cost",
    stockValue: "Stock value",
    stockValueFull: "Stock value",
    deleteTitle: "Delete resale item",
    deleteConfirm: "Delete “{name}”? This cannot be undone.",
    deleteBlocked: "Cannot delete — operations already exist",
  },
  products: {
  ...
  purchases: {
    title: "Purchases",
    description:
      "Ingredient or resale item — stock and average price update from here.",
