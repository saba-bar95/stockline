...
export function ProductHistoryModal({ productId, onClose }: Props) {
        ...
        <>
          <div className="mb-5 grid grid-cols-2 gap-x-10 gap-y-4 rounded-xl bg-paper px-5 py-4 text-sm text-ink-soft sm:grid-cols-3">
            ...
            <div className="min-w-0 space-y-1">
              ...
              <strong className="text-ink">
                {money(item.fullUnitCost, numberLocale)}
              </strong>
            </div>
            <div className="min-w-0 space-y-1">
              <div className="text-[0.7rem] font-semibold tracking-wide text-ink-muted uppercase">
              ...
              <strong className="text-ink">
                {qty(item.stock, numberLocale, qtyDecimals)}
              </strong>
            </div>
            <div className="min-w-0 space-y-1">
              <div className="text-[0.7rem] font-semibold tracking-wide text-ink-muted uppercase">
              ...
              <strong className="text-ink">
                {qty(item.qtyIn, numberLocale, qtyDecimals)}
              </strong>
            </div>
          </div>
          <DataTable
            ...
            columns={[
              ...
              },
              {
                key: "type",
                label: t("common.type"),
                title: t("history.typeTitleProduct"),
                sortValue: (r) => r.type,
